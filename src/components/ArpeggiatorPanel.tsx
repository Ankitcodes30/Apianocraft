            ...
            <div className="mt__row flex flex-wrap gap-2.5 items-center">
              ...
              <div className="mt__ctl mt__stepper flex flex-col gap-1 text-[11px] text-muted-foreground">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Badge variant="secondary" className="chip font-mono min-w-[3.5rem] inline-flex justify-center text-center tabular-nums" data-arp-octave-val>
                    {octave} Oct
                  </Badge>
                </div>
              </div>
              ...
              <label className="mt__ctl flex flex-col gap-1 text-[11px] text-muted-foreground">
                <div className="flex items-center justify-between w-full gap-2">
                  <span>Gate</span>
                  <span className="font-mono text-foreground tabular-nums min-w-[2.5rem] text-right">{Math.round(gate * 100)}%</span>
                </div>
                <input
                  type="range"
