...
export interface MainToneSnapshot {
  ...
  cutoffHz: number
  /** 0.001..2.0 seconds attack envelope time. */
  attackTime?: number
  /** 0.01..5.0 seconds release envelope time. */
  releaseTime?: number
  /** 0..1 wet/send level. */
  reverbAmount: number
...
export const DEFAULT_REVERB_PRESET: ReverbPresetId = 'room'

export const DEFAULT_MAIN_TONE_SNAPSHOT: Readonly<MainToneSnapshot> = Object.freeze({
  volume: 1,
  pan: 0,
  cutoffNorm: 1,
  cutoffHz: 20000,
...
export const DEFAULT_DUAL_TONE_SNAPSHOT: Readonly<MainToneSnapshot> = Object.freeze({
  volume: 0.8,
  pan: 0,
  cutoffNorm: 1,
  cutoffHz: 20000,
