...
export async function runPhase7({ page, check }) {
  ...
  check('UI octave +2 applies and displays', dTone.uiOctave.value === 2 && String(dTone.uiOctave.chip).includes('+2'), `${dTone.uiOctave.value} chip="${dTone.uiOctave.chip}"`)
  check('UI transpose -3 applies and displays', dTone.uiTranspose.value === -3 && String(dTone.uiTranspose.chip).includes('-3'), `${dTone.uiTranspose.value} chip="${dTone.uiTranspose.chip}"`)
  check('UI tune +10 applies and displays', dTone.uiTune.value === 10 && String(dTone.uiTune.chip).includes('+10'), `${dTone.uiTune.value} chip="${dTone.uiTune.chip}"`)
